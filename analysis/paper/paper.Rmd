...
words_only_many <- subset(words_only, words_only$sum > 1) # subset to words that occur more than once
...
library(classInt)
res <- plotJenks(heat1$value, n = 10) # to get an idea how to classify (many other possibilities) 

# categorise data
heat1$category <- cut(heat1$value, 
                   breaks=c(-Inf,0, 1, 2, 3, 5, 8, 12, 21, 33, 123, Inf), 
                   labels=c("0", "1", "2","3", "4-5", "6-8", "10-12", "18-21", "33", "123", 200))
...
ggplot(heat1, aes(row, col))+
  ...
  scale_fill_manual(name = "Frequency of co-occurence", 
                    values = col,
                    breaks = c("0", "1", "2","3", "4-5", "6-8", "10-12", "18-21", "33", "123")) +
  theme(axis.text.x  = element_text(angle=45, vjust=1, hjust = 1))+
  xlab("")+
  ylab("")+
  labs(caption = "Words occuring more than once in the data set")
